...
# Endpoint that gives all candidates calling the controller
...
# Endpoint that gives a candidate by it is id calling the controller
...
# Endpoint that inserts a candidate calling the controller
...
# Endpoint that updates a candidate calling the controller
...
# Endpoint that relations a candidate to a party calling the controller
...
# Endpoint that deletes a candidate calling the controller
