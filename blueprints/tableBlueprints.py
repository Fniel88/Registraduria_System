...
# Endpoint that gives whole tables calling the controller
...
# Endpoint that gives a table by it is id calling the controller
...
# Endpoint that inserts a table calling the controller
...
# Endpoint that updates a table calling the controller
...
# Endpoint that deletes a table calling the controller
